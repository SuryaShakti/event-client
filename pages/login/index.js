...
const login = () => {
  ...
  return (
    <div className="z-50 text-white max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex min-h-screen justify-center rounded-xl items-center overflow-hidden">
      <div className="w-full md:h-4/5 bg-white bg-opacity-10 rounded-xl grid grid-cols-1 lg:grid-cols-2">
        <div className="hidden md:flex flex-col justify-center items-center border border-r-gray-600 border-t-0 border-b-0 border-l-0">
          <div className="p-3 bg-white flex justify-center items-center rounded-2xl bg-opacity-10">
          ...
          <div className="my-2 text- w-4/5 text-center">
            ...
            pharetra luctus et donec arcu. Nibh sed venenatis Nibh sed venenatis
            ac tristique eleifend fames id. Curabitur vulputate lacus viverra
            rutrum iaculis maecenas elementum sit lacus.
          </div>
        </div>
