...
const ChatBox = () => {
  ...
  return (
    <div className="min-h-[95vh] flex flex-col px-5 md:px-10 py-4">
      <div className="flex-1 flex justify-end flex-col bg-gray-200 bg-opacity-20 rounded-2xl p-2 sm:p-3 md:p-5">
